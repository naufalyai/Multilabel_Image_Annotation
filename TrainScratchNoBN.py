...
model_name = 'keras_nus_trained_model_skenario2_15DO.h5'
weight_name = 'keras_nus_trained_weight_skenario2_15DO.h5'
...
print(model.summary())
checkpoint = ModelCheckpoint("./saved_models/skenario22_2.h5", monitor='val_top_k_categorical_acc', verbose=1, save_best_only=True,
